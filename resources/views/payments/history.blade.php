<x-app-with-sidebar>
    ...
    <!-- Filters -->
    <x-card class="mb-6">
        <form method="GET" action="{{ route('payments.history') }}" class="flex flex-wrap gap-4">
    ...
    @else
        <x-card>
            <div class="text-center py-12">
                ...
                <h3 class="mt-2 text-sm font-medium text-gray-900 dark:text-gray-100">Tidak ada riwayat pembayaran</h3>
                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Anda belum memiliki transaksi pembayaran.</p>
            </div>
        </x-card>
    @endif
</x-app-with-sidebar>
