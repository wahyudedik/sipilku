        ...
        <div class="text-center py-8">
            @if($transaction->status === 'completed')
                ...
                <p class="text-gray-600 dark:text-gray-400 mb-6">
                    Saldo sebesar Rp {{ number_format($transaction->amount, 0, ',', '.') }} telah berhasil ditambahkan ke akun Anda.
                </p>
            @elseif($transaction->status === 'processing' || $transaction->status === 'pending')
                ...
                <h3 class="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-2">Top-up Pending</h3>
                <p class="text-gray-600 dark:text-gray-400 mb-6">
                    Pembayaran Anda sedang diproses. Kami akan mengirimkan notifikasi setelah top-up berhasil.
                </p>
            @else
                ...
                <h3 class="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-2">Top-up Gagal</h3>
                <p class="text-gray-600 dark:text-gray-400 mb-6">
                    Top-up saldo Anda gagal diproses. Silakan coba lagi atau hubungi customer service.
                </p>
            @endif
            ...
            <div class="space-y-4">
                <div class="bg-gray-50 dark:bg-gray-800 rounded-lg p-4 text-left max-w-md mx-auto">
                    <div class="space-y-2">
                        <div class="flex justify-between">
                            ...
                            <span class="font-medium text-gray-900 dark:text-gray-100">{{ $transaction->uuid }}</span>
                        </div>
                        <div class="flex justify-between">
                ...
                <div class="flex justify-center space-x-4">
                    <a href="{{ route('balance.index') }}">
                        <x-button variant="primary">Kembali ke Saldo</x-button>
                    </a>
