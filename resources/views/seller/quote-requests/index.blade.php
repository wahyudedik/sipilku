<x-app-with-sidebar>
    ...
    <!-- Filters -->
    <x-card class="mb-6">
        <form method="GET" action="{{ route('seller.quote-requests.index') }}" class="flex flex-wrap gap-4">
            ...
            <div class="flex-1 min-w-[200px]">
                <x-select-input 
                    name="service" 
                    :options="['' => 'Semua Jasa'] + $services->pluck('title', 'id')->toArray()"
                ...
                <x-card>
                    <div class="flex items-start justify-between">
                            ...
                            <div class="flex items-start space-x-4">
                                ...
                                <div class="flex-1">
                                    ...
                                    <p class="text-sm text-gray-500 dark:text-gray-400 mb-2">
                                        Dari: <span class="font-medium">{{ $quoteRequest->user->name }}</span>
                                    </p>
                        ...
                        <div class="ml-4 flex flex-col items-end space-y-2">
                            ...
                            @endif
                            <a href="{{ route('seller.quote-requests.show', $quoteRequest) }}" 
    ...
    @else
        <x-card>
            <div class="text-center py-12">
                ...
                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Belum ada permintaan quote untuk jasa Anda.</p>
            </div>
        </x-card>
    @endif
</x-app-with-sidebar>
