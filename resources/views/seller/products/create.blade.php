        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2 space-y-6">
                <x-card>
                    ...
                    <x-form-group label="Judul Produk" name="title" required>
                        <x-text-input name="title" value="{{ old('title') }}" placeholder="Contoh: Template RAB Proyek Gedung" />
                    </x-form-group>

                    <x-form-group label="Slug (URL)" name="slug" help="Akan di-generate otomatis dari judul jika dikosongkan">
                        <x-text-input name="slug" value="{{ old('slug') }}" placeholder="template-rab-proyek-gedung" />
                    </x-form-group>
                ...
                <x-card>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <x-form-group label="Harga Normal" name="price" required>
                            <x-text-input name="price" type="number" step="0.01" value="{{ old('price') }}" placeholder="0" />
                        </x-form-group>

                        <x-form-group label="Harga Diskon (Opsional)" name="discount_price" help="Harus lebih kecil dari harga normal">
                            <x-text-input name="discount_price" type="number" step="0.01" value="{{ old('discount_price') }}" placeholder="0" />
                        </x-form-group>
                    </div>
                </x-card>
                ...
                <x-card>
                    ...
                    <x-form-group label="File Produk" name="file" required help="Format: ZIP, RAR, PDF, DOC, XLS, DWG, SKP, RVT. Maksimal 100MB">
                        <input type="file" 
                               name="file" 
            ...
            <div class="space-y-6">
                ...
                <x-card>
                    ...
                    <x-form-group label="Galeri (Maksimal 5)" name="gallery_images" help="Format: JPG, PNG, GIF, WEBP. Maksimal 2MB per gambar">
                        <input type="file" 
                               name="gallery_images[]" 
                               accept="image/*"
                               multiple
